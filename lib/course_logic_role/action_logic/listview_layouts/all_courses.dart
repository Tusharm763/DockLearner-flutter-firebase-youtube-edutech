...
class ViewOrganizingAllCoursesDetails extends StatefulWidget {
  const ViewOrganizingAllCoursesDetails({super.key});

  @override
  State<ViewOrganizingAllCoursesDetails> createState() => _ViewOrganizingAllCoursesDetailsState();
}

class _ViewOrganizingAllCoursesDetailsState extends State<ViewOrganizingAllCoursesDetails> {
  // Stream? loadCourse;

  // StreamController<Stream<dynamic>> sControl = StreamController<Stream<dynamic>>();
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Card(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  (eachInListView["Author"] == UserData.googleUserName)
                                                                                      ? "Manage"
                                                                                      : "View",
